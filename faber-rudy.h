 ...
 * Faber G et al - Kinetic Properties of the Cardiac L-type Ca Channel and its
 * Role in Myocyte Electrophysiology. Biophys. J. 2006, 92: 1522-1543
 * 
 *** NOTES
 *
 * Real-time optimized ventricular guinea pig myocyte model. Uses lookup tables
 * and the RealTimeMath library to eliminate spikes in computation time seen
 * with the generic math library. Code adapted from code used by Rebecca
 * Nicklas-Ahrens in:
 *
 * Anthropomorphizing the Mouse Cardiac Action Potential via a Novel Dynamic
 * Clamp Method
 *
...
#include <rtmath.h>            // RealTimeMath library
